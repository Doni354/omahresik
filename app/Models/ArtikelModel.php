...
class ArtikelModel extends Model
{
    ...
    protected $allowedFields = ['id_artikel', 'meta_title_id', 'meta_description_id', 'meta_title_en', 'meta_description_en', 'slug_in', 'slug_en', 'judul_artikel_in','judul_artikel_en', 'foto_artikel', 'deskripsi_artikel'];
