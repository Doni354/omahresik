...
$routes->group('id', function ($routes) {
    ...
    $routes->get('tentang', 'user\Aboutctrl::index');
    // route halaman produk
    $routes->get('layanan', 'user\Productsctrl::index');
    $routes->get('layanan/(:segment)', 'user\Productsctrl::detailBySlug/$1');
    // routes halaman aktivitas
    $routes->get('aktivitas', 'user\Aktivitasctrl::index');
    $routes->get('aktivitas/(:segment)', 'user\Aktivitasctrl::detailBySlug/$1');
...
$routes->group('en', function ($routes) {
    ...
    // route halaman produk
    $routes->get('service', 'user\Productsctrl::index');
    $routes->get('service/(:segment)', 'user\Productsctrl::detailBySlug/$1');
    // routes halaman aktivitas
...
// $routes->get('en', 'user\Homectrl::index');// Tambahkan ini untuk rute bahasa Inggris
// // route home beranda
