                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control tiny" id="meta_title_id" name="meta_title_id"><?= $aktivitasData->meta_title_id; ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Meta Description (Id)</label>
                                    <textarea type="text" class="form-control tiny" id="meta_description_id" name="meta_description_id"><?= $aktivitasData->meta_description_id; ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Meta Title (En)</label>
                                    <textarea type="text" class="form-control tiny" id="meta_title_en" name="meta_title_en"><?= $aktivitasData->meta_title_en; ?></textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Meta Description (En)</label>
                                    <textarea type="text" class="form-control tiny" id="meta_description_en" name="meta_description_en"><?= $aktivitasData->meta_description_en; ?></textarea>
                                </div>
                                <div class="mb-3">
