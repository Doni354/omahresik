                                ...
                                <tbody>
                                    <?php foreach ($all_data_aktivitas as $tampilAktivitas) : ?>
                                        <tr>
                                            ...
                                            <td><?= $tampilAktivitas->meta_title_id ?></td>
                                            <td><?= $tampilAktivitas->meta_description_id ?></td>
                                            <td><?= $tampilAktivitas->meta_title_en ?></td>
                                            <td><?= $tampilAktivitas->meta_description_en ?></td>
