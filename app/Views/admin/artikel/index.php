                    ...
                    <div class="app-card-body">
                        <div class="table-responsive">
                            <table class="table app-table-hover mb-0 text-left">
                                <thead>
                                    <tr>
                                        <th class="text-center" valign="middle">Judul Artikel In</th>
                                ...
                                <tbody>
                                    <?php foreach ($artikels as $artikel) : ?>
                                        <tr>
                                            <td><?= $artikel->judul_artikel_in ?></td>
                                            <td><?= $artikel->judul_artikel_en ?></td>
                                            <td><?= $artikel->deskripsi_artikel ?></td>
                                            <td><?= $artikel->meta_title_id ?></td>
                                            <td><?= $artikel->meta_description_id ?></td>
                                            <td><?= $artikel->meta_title_en ?></td>
                                            <td><?= $artikel->meta_description_en ?></td>
